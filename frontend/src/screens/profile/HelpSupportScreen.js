 ...
 * Help & Support Screen
 *
 * Provides users with assistance options:
 * - Direct contact via phone or email.
 * - A collapsible FAQ section for common questions.
 * ensuring users can resolve issues or get guidance easily.
 */
const HelpSupportScreen = ({ navigation }) => {
  ...
  const handleCallSupport = () => {
    Linking.openURL("tel:8247483075");
  };

  const handleEmailSupport = () => {
    Linking.openURL(
      "mailto:kgssiddhu@gmail.com?subject=FarMarket%20Support%20Request",
    );
  };
