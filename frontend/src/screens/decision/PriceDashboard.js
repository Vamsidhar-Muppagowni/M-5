...
const PriceDashboard = ({ navigation }) => {
    ...
    const fetchCropsAndRecent = async () => {
        try {
            ...
            const cropsRes = await api.get('/market/crops?page=1&limit=100');
            const cropList = cropsRes.data.crops || [];
            
            // Get unique crop names to avoid duplicates
            const uniqueCropNames = [...new Set(cropList.map(crop => crop.name))];
            ...
            <View style={styles.insightCard}>
                ...
                <View style={{ flex: 1 }}>
                    <View style={styles.insightTitleRow}>
                        ...
                        <Tooltip text={t('six_month_tooltip') || 'This shows the overall price movement over 6 months. Green indicates price increase, red indicates decrease.'} iconSize={14} />
                    </View>
            ...
            >
                <View style={styles.pickerContainer}>
                    <View style={styles.labelRow}>
                        ...
                        <Tooltip text={t('select_crop_tooltip') || 'Choose a crop to view its price trends and market analysis over the past 6 months.'} iconSize={16} />
                    </View>
                ...
                <View style={styles.updatesSection}>
                    <View style={styles.updatesTitleRow}>
                        ...
                        <Tooltip text={t('recent_updates_tooltip') || 'Latest price updates from major mandis across India. These prices are updated daily and help you understand current market rates for different crops. Use this information to set competitive prices for your produce.'} iconSize={16} />
                    </View>
